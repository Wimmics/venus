 ...
 * 
 * Extends SparqlToGraphMapper with force graph-specific logic. Transforms SPARQL results
 * into canonical node-link format with physics-simulation-ready data structure.
 * 
 * Output format: { nodes: [...], links: [...] }
 * - nodes: Array of node objects with id, label, color, size, and other encoded properties
